...
@Component({
  selector: 'alv-softskill-delete',
  templateUrl: './softskill-delete.component.html',
  styleUrls: ['./softskill-delete.component.scss']
})
export class SoftskillDeleteComponent implements OnInit {
  ...
  warning = {
    ...
    messageKey: 'portal.competence-catalog.softskills.delete-modal.reference-found-alert',
    isSticky: true
  };
  ...
  ngOnInit() {
    this.chFiches$ = this.chFicheRepository.findBySoftskillId(this.softskill);
  }
  ...
  delete() {
    this.activeModal.close(this.softskill);
  }
